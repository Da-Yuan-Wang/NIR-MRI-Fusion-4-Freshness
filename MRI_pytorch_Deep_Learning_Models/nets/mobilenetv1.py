...
model_urls = {
    'mobilenet_v1': 'https://drive.google.com/drive/folders/1pKn-RifvJGWiOx0ZCRLtCXM5GT5lAluu?usp=sharing',
}
import torch
__all__ = ['mbv1']
...
def mbv1(pretrained=False, progress=True, num_classes=1000):
    model = MobileNetV1()
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilenet_v1'], model_dir='./model_data',
                                              progress=progress)
