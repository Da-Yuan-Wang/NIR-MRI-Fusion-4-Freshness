...
joblib.dump(svm_model, 'NIR_sklearan_Machine_Learning_Models\svc_model.pkl')
print("SVC model saved as 'NIR_sklearan_Machine_Learning_Models\svc_model.pkl'")
