...
# For multi-class problems, coef_'s shape is (number of classes, number of features)
...
# Get top 15 most important features, sorted by importance from high to low ([::-1] achieves reverse sorting)
...
plt.title('Top 20 Feature Importances (NIR)', fontsize=16)
plt.tight_layout()
plt.show()