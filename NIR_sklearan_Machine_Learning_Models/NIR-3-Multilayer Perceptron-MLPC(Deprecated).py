...
# Use smaller samples for grid search to save time
...
with open('NIR_sklearan_Machine_Learning_Models\mlpc_model.pkl', 'wb') as f:
    pickle.dump(model_data, f)

print("MLP model saved as NIR_sklearan_Machine_Learning_Models\mlpc_model.pkll file")
